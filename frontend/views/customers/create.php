...
<div class="customer-create">
    ...
    <h1><?= Html::encode($this->title) ?></h1>
        ...
        <?= $form->field($model, 'adress')->textarea(['maxlength' => true])->label(Customer::labels('adress')) ?>
        <?= $form->field($model, 'phone')->widget(\yii\widgets\MaskedInput::className(),['mask' => '+3 (999) 999 99 99'])->label(Customer::labels('phone')) ?>
